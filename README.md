# Proyecto de ejemplo SDK Web JS

Este proyecto permite probar y conocer la implementación de los productos de Transbank mediante el [SDK POS Web](https://github.com/TransbankDevelopers/transbank-pos-sdk-web-js), con la finalidad de facilitar la puesta en marcha con tu POS Integrado. Este proyecto te permite realizar diferentes operaciones, experimentar con los flujos de pago y conocer las respuestas entregadas por el POS.

Este proyecto requiere de un [Agente Web](https://github.com/TransbankDevelopers/transbank-pos-sdk-web-agent2) para poder funcionar. El agente Web expone una conexión que le permite recibir peticiones desde un navegador.

El proyecto de ejemplo está construido utilizando el framework [React](https://es.react.dev/).

Puedes revisar el proyecto funcionando en este enlace [https://proyecto-ejemplo-pos-js.transbankdevelopers.cl/](https://proyecto-ejemplo-pos-js.transbankdevelopers.cl/)

## Requisitos

- Node >= 20.
- SDK de POS Web JS >= 5.1.0
